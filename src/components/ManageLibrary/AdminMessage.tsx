...
export const AdminMessage: React.FC<{message: MessageModel, submitResponseToQuestion:any}> = (props: any) => {
      ...
      <div className="card mt-2 shadow p-3 bg-body rounded">
        ...
        <div>
          ...
          <form action="PUT">
            ...
            <div>
              <button type="button" onClick={submitResponse} className="btn btn-primary mt-3">Submit Response</button>
            </div>
          </form>
        </div>
      </div>
