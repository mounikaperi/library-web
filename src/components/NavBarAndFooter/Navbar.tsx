          ...
          <div className='collapse navbar-collapse' id='navbarNavDropdown'>
            <ul className='navbar-nav'>
              ...
              <li className='nav-item'><NavLink className='nav-link' to='/search'>Search Books</NavLink></li>
              {
                ...
                <li className="nav-item"><NavLink className='nav-link' to='/shelf'>Shelf</NavLink></li>
              }
              {
            ...
            <ul className='navbar-nav ms-auto'>
              {!authState.isAuthenticated
                ? <li className='nav-item m-1'><Link type='button' className='btn btn-outline-light' to='/login'>Sign In</Link></li>
